...
module.exports = {
  getProductsBranchsByIdProduct: (req, res) => {
    productsBranchsModel
      .getProductsBranchsByIdProduct(req.params.id)
      .then(response => {
  ...
  patchProductsBranchs: (req, res) => {
    productsBranchsModel
      .patchProductsBranchs(req.body, req.params.id)
      .then(response => {
        respon.success(res, 200, response);
      })
      .catch(err => {
  ...
  deleteProductsBranchs: (req, res) => {
    productsBranchsModel
      .deleteProductsBranchs(req.params.id)
      .then(response => {
        respon.success(res, 200, response);
      })
      .catch(err => {
